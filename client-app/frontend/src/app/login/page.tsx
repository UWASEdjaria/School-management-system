      ...
      <div className="bg-[#1e293b] p-8 rounded-2xl border border-white/10 shadow-2xl w-96 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#4f46e5] hover:bg-[#4338ca] text-white font-semibold py-3 rounded-xl shadow-lg shadow-[#4f46e5]/20 transition-all transform active:scale-[0.98] disabled:opacity-50"
          >
        ...
        <div className="mt-8 text-center space-y-3">
          <p className="text-sm text-[#94a3b8]">
            Don't have an account? <a href="/register" className="text-[#818cf8] hover:underline font-medium">Create Account</a>
          </p>
